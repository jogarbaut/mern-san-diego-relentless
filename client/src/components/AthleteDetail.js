                    ...
                    >
                      <Modal.Header closeButton>
                        <Modal.Title id="example-custom-modal-styling-title">
                          Add to Gamelog for {athlete.firstName}{" "}
                          {athlete.lastName}
                        </Modal.Title>
                      </Modal.Header>
                      <Modal.Body>
                        <Form
                          className="gamelog-form"
                        ...
                        >
                            ...
                            <Form.Group as={Col} controlId="formOpponentScore">
                              ...
                              <Form.Control
                                ...
                                onChange={(e) => {
                                  ...
                                  setResult(
                                    determineResult(score, e.target.value)
                                  );
                                }}
                                value={opponentScore}
                          ...
                          <Button
                            type="submit"
                            className="gamelog-submit-button"
                          >
                            Add Game
                          </Button>{" "}
